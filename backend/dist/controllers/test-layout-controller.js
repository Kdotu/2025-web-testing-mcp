...
exports.TestLayoutController = void 0;
const test_layout_service_1 = require("../services/test-layout-service");
class TestLayoutController {
    constructor() {
        this.testLayoutService = new test_layout_service_1.TestLayoutService();
    }
    async getAllLayouts(_req, res) {
        try {
    ...
    async getLayoutsByTestType(req, res) {
        try {
    ...
    async createField(req, res) {
        try {
            const { layoutId, sectionId, fieldName, fieldType, label, placeholder, description, isRequired, isVisible, fieldOrder, fieldWidth, defaultValue, validationRules, options, conditionalLogic } = req.body;
...
exports.TestLayoutController = TestLayoutController;
//# sourceMappingURL=test-layout-controller.js.map