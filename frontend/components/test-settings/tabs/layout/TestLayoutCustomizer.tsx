  ...
  const defaultFields: { [key: string]: LayoutField[] } = {
    lighthouse: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: 'accessibility', label: '접근성 (Accessibility)' },
          { value: 'best-practices', label: '모범 사례 (Best Practices)' },
      ...
      },
      {
        ...
        name: 'throttling',
        type: 'select',
        label: '네트워크 제한 (Throttling)',
        options: [
          { value: '4g', label: '4G (고속)' },
          { value: '3g', label: '3G (중속)' },
          { value: '2g', label: '2G (저속)' },
    ...
    playwright: [
      ...
      },
      {
        ...
        label: '뷰포트 크기',
        options: [
          { value: '1920x1080', label: '1920x1080 (데스크톱)' },
          { value: '1366x768', label: '1366x768 (노트북)' },
          { value: '768x1024', label: '768x1024 (태블릿)' },
          { value: '375x667', label: '375x667 (모바일)' }
        ],
                        ...
                        <div key={field.id} className="flex items-center gap-3 p-3 border rounded">
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-muted-foreground">
                              ...
                              너비: {field.width || 'full'} • 높이: {field.height || 'auto'}
                            </p>
                          </div>
